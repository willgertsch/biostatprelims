...
$$
## c
$\mu = a/b$, therefore $\hat \mu = \hat a/\hat b$ by the invariance property of MLEs. We can use to 2nd likelihood equation from before to say that $\hat \mu = \bar X$. Therefore
$$
