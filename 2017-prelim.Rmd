...
$$
P \left(\bar X - \bar Y - 1.96*25\sqrt{\frac{1}{100} + \frac{1}{300}} < \mu_x-\mu_y < \bar X - \bar Y + 1.96*25\sqrt{\frac{1}{100} + \frac{1}{300}}\right) = .95
$$
Therefore, the probability that the CI includes 0 is .95 because that is literally how the CI is defined.
